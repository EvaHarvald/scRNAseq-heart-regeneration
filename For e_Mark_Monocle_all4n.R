...
combined.all <- merge(x = E16.5.4n, y = c(P1.4n, P5.4n), add.cell.ids = c("E16.5.4n", "P1.4n", "P5.4n"), 
                      project = "mouse2n")
...
tiff(file = "tSNE_combined_4n.tiff", width = 5500, height = 7500, units = "px", res = 950, pointsize = 12)
plot_cell_clusters(combined.monocle)
dev.off()

tiff(file = "tSNE_combined_orig_ident_4n.tiff", width = 5500, height = 6500, units = "px", res = 950, pointsize = 12)
plot_cell_clusters(combined.monocle, color_by = 'orig.ident')
dev.off()

tiff(file = "tSNE_combined_CCphase_4n.tiff", width = 5500, height = 6500, units = "px", res = 950, pointsize = 12)
plot_cell_clusters(combined.monocle, color_by = 'Phase')
dev.off()

tiff(file = "tSNE_combined_myomarkers_4n.tiff", width = 11000, height = 6500, units = "px", res = 950, pointsize = 12)
...
#Set wd 
tiff(file = "trajectory_4n.TFs.tiff", width = 5500, height = 4500, units = "px", res = 950, pointsize = 12)
plot_cell_trajectory(combined.monocle, markers = c("Myc", "Mycn", "Arnt", "Zeb1", "Sp1"), use_color_gradient = TRUE)
dev.off()


tiff(file = "trajectory_all.orig.ident_4n.tiff", width = 5500, height = 4500, units = "px", res = 950, pointsize = 12)
...
tiff(file = "trajectory_all.pseudotime_4n.tiff", width = 5500, height = 4500, units = "px", res = 950, pointsize = 12)
plot_cell_trajectory(combined.monocle, color_by = "Pseudotime")
dev.off()

tiff(file = "trajectory_all.phase_4n.tiff", width = 5500, height = 4500, units = "px", res = 950, pointsize = 12)
...
for (i in 1:res) {
  ...
  filename <- paste("Branch point", i, "4n.txt", sep="")
...
for (i in 1:res) {
  file_name = paste("heatmap_BP", i, "4n.tiff", sep="")
